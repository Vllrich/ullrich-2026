...
const en: LandingCopy = {
  ...
  cover: {
    ...
    headlineAlt: 'for software that has to work',
    body: 'I help growing companies ship software that holds up in production, and keep it running AI included, when it earns its place',
  ...
  contact: {
    ...
    form: {
      ...
      successBody: 'Thanks. I read every message personally and usually reply within a day.',
      close: 'Close',
      closesIn: 'Closes in',
    },
    footer: {
...
const de: LandingCopy = {
  meta: {
    title: 'Lars Ullrich - Production AI, Agenten-Zuverlässigkeit & Fractional CTO',
    description:
  ...
  cover: {
    descriptor: 'Agenten-Zuverlässigkeit · Full-Stack Engineer & Fractional CTO',
    navLabel: 'Hauptnavigation',
    menuOpen: 'Menü öffnen',
    menuClose: 'Menü schließen',
    heroLabel: 'Hero',
    headline: 'Engineering Leadership',
    headlineAlt: 'für Software, die halten muss',
    body: 'Ich helfe wachsenden Unternehmen, Software zu shippen, die in Produktion hält, und sie am Laufen zu halten. KI inklusive, wenn sie ihren Platz verdient',
    ...
    items: [
      {
        ...
        tags: ['Use-Case-Mapping', 'Agenten-Feasibility', 'Build vs Buy', 'Risiko & EU-AI-Act-Check', 'Kostenmodell'],
        href: '/services/readiness-audit/',
      },
      {
        title: 'Build Sprint',
        ...
        tags: ['Frontend bis Infra', 'Python & TypeScript', 'Agenten & RAG', 'Offene oder gehostete Modelle', 'Monitoring & Guardrails'],
      },
      {
        title: 'Corporate LLM',
        cat: 'Plattform',
        ...
        tags: ['Private / offene Modelle', 'RAG über Firmendaten', 'Zugriff & Audit-Trails', 'Kosten- & Rate-Limits', 'EU-tauglicher Ops'],
      ...
      },
      {
        ...
        tags: ['Evals & Monitoring', 'Guardrails', 'Drift- & Kostenkontrolle', 'Incident Response'],
      ...
      },
      {
        ...
        tags: ['Architektur & Roadmap', 'Team- & Vendor-Auswahl', 'Delivery Ownership', 'Board-Reporting'],
  ...
  contact: {
    ...
    form: {
      ...
      successBody: 'Danke. Ich lese jede Nachricht persönlich und antworte meist innerhalb eines Tages.',
      close: 'Schließen',
...
export function landingSectionHref(lang: LandingLang, key: keyof LandingIds): string {
